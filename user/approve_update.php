<?php
  ...
  $nippegawai = $_GET['nip'];
	$now = date('Y-m-d');
	$Sql = "SELECT * FROM cuti_pegawai ct, pegawai pg, jabatan jb, golongan gl WHERE ct.id_pegawai=pg.id_pegawai AND pg.id_jabatan=jb.id_jabatan AND pg.id_golongan=gl.id_golongan AND pg.nip='$nippegawai'";
