...
<html lang="en">
  <head>
    ...
    <title>DPPA | Dashboard User</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php?page=dashboard" class="site_title"><i class="fa fa-university"></i><span>  DPPA</span></a>
            </div>
        ...
        <footer>
          <div class="pull-right">
            DPPA - Copyright © 2020 Develop by <a href="https://zakariawahyu.github.io/">Zakaria</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
